...
// Normal Select Custom for default value is nothing
Form::macro('normalSelectCustom', function ($name, $title, ViewErrorBag $errors, array $choice, $object = null, array $options = []) {
    if (array_key_exists('multiple', $options)) {
        $nameForm = $name . '[]';
    } else {
        $nameForm = $name;
    ...
    //$choice handle
    array_unshift($choice, '-----Chose One-----');
