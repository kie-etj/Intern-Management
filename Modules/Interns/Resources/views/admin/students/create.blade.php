...
@section('content-header')
    <h1>
        {{ trans('interns::students.title.create student') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.interns.student.index') }}">{{ trans('interns::students.title.students') }}</a></li>
        <li class="active">{{ trans('interns::students.title.create student') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.interns.student.store'], 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('interns::admin.students.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
